                            ...
                            <ul id="share_buttons" class="list-unstyled">
                                ...
                                <li>
                                    <div class="form-group">
                                        ...
                                        <input id="share_buttons_tumblr" name="share_buttons[tumblr]" type="checkbox" value="1" <?php echo (!empty($settings->share_buttons->tumblr) && $settings->share_buttons->tumblr == '1') ? 'checked' : '' ?>>         
                                    </div>
                                </li>
                            </ul>
                        </div>
