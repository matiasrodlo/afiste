...
function seed_cspv5_section_getresponse($emaillist,$page_id) {
    // Get settings
 ...
 */
function seed_cspv5_get_getresponse_lists(){
    $getresponse_api_key = $_REQUEST['getresponse_api_key'];
    $page_id = $_REQUEST['page_id'];
    $emaillist = $_REQUEST['emaillist'];
    $lists = array();

            require_once SEED_CSPV5_PLUGIN_PATH.'extentions/getresponse/seed_cspv5_GetResponseAPI.class.php';
 ...
 */
add_action('seed_cspv5_emaillist_getresponse', 'seed_cspv5_emaillist_getresponse_add_subscriber');

function seed_cspv5_emaillist_getresponse_add_subscriber($args){
        ...
        extract($e_settings);
                ...
                if(empty($response)){
                    ...
                    //     seed_cspv5_emaillist_database_add_subscriber();
                    // }
